...
@Entity
@NoArgsConstructor
@Table(name = "shopping_malls_of_seoul",//modified_by_id인덱싱 추가. 인덱스 이름 변경해야 하는가?
indexes = {@Index(name = "idx_shopping_mall_total_rating_store_status_id", columnList = "total_rating, store_status, modified_by_id, id")})
