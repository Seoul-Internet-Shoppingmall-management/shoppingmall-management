package com.example.plusproject.queryDSL.dto;
...
public class QueryDSLResponseDto {
    ...
    public static QueryDSLResponseDto of(ShoppingMall shoppingMall) {
        return new QueryDSLResponseDto(
                shoppingMall.getId(),
